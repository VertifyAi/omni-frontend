...
import FreshdeskTutorial from "@/components/FreshdeskTutorial";
...
const externalIntegrations = [
  {
    name: "Freshdesk",
    type: "FRESHDESK",
    description: "Gerencie suas chamadas de atendimento em um só lugar.",
    icon: "https://vertify-public-assets.s3.us-east-2.amazonaws.com/social-media/freshdesk-icon.svg",
    connected: false,
    soon: false,
  },
];
...
export default function IntegrationsPage() {
  ...
  const handleDeactivate = async (type: string) => {
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : "Erro ao desativar integração"
      );
    } finally {
  ...
  const isIntegrationActive = (type: string) => {
    return integrations.some(
      (integration) => integration.type === type && integration.active
    );
  };
  ...
  const handleConnect = (networkName: string) => {
    ...
    if (networkName === "Freshdesk") {
      setShowFreshdeskTutorial(true);
    }
  };
    ...
    return (
      <div className="container p-8">
        <WhatsAppTutorial
          ...
          onDeactivate={
            whatsappActive ? () => handleDeactivate("WHATSAPP") : undefined
          }
      ...
      <div className="container p-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Conecte suas redes sociais para gerenciar todas as conversas em um
            só lugar.
          </p>
        </div>
  ...
  return (
    <div className="container p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {externalIntegrations.map((network, index) => {
      ...
      <div className="mb-8 mt-10">
        ...
        <p className="text-muted-foreground mt-2">
          Conecte seus canais de atendimento para gerenciar todas as conversas
          em um só lugar.
        </p>
      </div>
